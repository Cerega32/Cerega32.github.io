(function(){
	...
	$('.header__panel-slider').slick({
		...
		speed: 500,
		variableWidth: true,
		prevArrow: '<button class="header__panel-reference header__panel-reference--prev")> PREV</button>',
		nextArrow: '<button class="header__panel-reference header__panel-reference--next")> NEXT</button>'
	});
